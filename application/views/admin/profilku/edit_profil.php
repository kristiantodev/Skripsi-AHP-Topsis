            ...
            <div class="col-lg-8 mx-auto">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h4 class="m-0 font-weight-bold text-primary text-uppercase"><i class="fa fa-edit"></i> Form Edit Profil</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('profilku/edit_profil'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Masukan Username" value="<?= $datauser->username ?>" readonly>
                                    </div>
