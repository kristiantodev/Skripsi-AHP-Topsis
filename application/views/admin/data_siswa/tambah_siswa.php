            ...
            <div class="col-lg-8 mx-auto">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h4 class="m-0 font-weight-bold text-primary text-uppercase"><i class="fa fa-edit"></i> Form Tambah Siswa</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('data_siswa/tambah_siswa'); ?>">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nis" name="nis" placeholder="Masukan NIS" value="<?= set_value('nis') ?>">
                                    </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" placeholder="Masukan Nama Siswa" value="<?= set_value('nama_siswa') ?>">
                                    </div>
